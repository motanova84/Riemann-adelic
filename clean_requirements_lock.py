...
def clean_requirements_lock(input_file, output_file):
    ...
    with open(output_file, "w") as f:
        ...
        testing = ["pytest", "pytest-cov", "pytest-rerunfailures", "coverage", "pluggy", "iniconfig"]
        accel = ["numba", "llvmlite", "jax", "jaxlib", "opt-einsum", "numexpr", "bottleneck"]
        quantum = ["qiskit", "qiskit-aer", "qiskit-ibm-runtime", "rustworkx"]
        ml = ["scikit-learn", "xgboost"]
        network = ["requests", "urllib3", "charset-normalizer", "idna", "certifi", "httpx", "httpcore", "h11"]
