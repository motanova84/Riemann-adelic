...
def get_coherence_data():
    ...
    data = {"timestamps": [], "coherence": [], "target": COHERENCE_TARGET}
...
def get_agent_metrics():
    ...
    return {
        "qcal_prover": {"status": "ready", "validations": 0, "last_run": None},
        "axiom_emitter": {"status": "ready", "axioms_generated": 5, "last_run": None},
        "code_synthesizer": {"status": "ready", "components_generated": 3, "last_run": None},
    }
...
def api_run_validation():
    ...
    try:
        ...
        return jsonify({"status": "timeout", "message": "Validation exceeded 30s timeout"}), 408
