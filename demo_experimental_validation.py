...
def demo_fase_ii():
    ...
    datos_test = {"tensor": T_μν, "fmri_amigdala": datos["amigdala"]}
...
def demo_fase_iii():
    ...
    resultados = simular_experimento_completo(
        n_participantes=100, n_intervenidos=20, num_pasos=50, verbose=False  # Reducido para demo
    )
...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description="Demostración del Protocolo de Validación Experimental QCAL")
    parser.add_argument("--fase", type=int, choices=[1, 2, 3, 4], help="Ejecutar solo la fase especificada (1-4)")
