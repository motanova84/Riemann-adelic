...
def main():
    ...
    print("=" * 70)
    print(f"Teorema certificado: Rψ(5,5) ≤ 16")
    print(f"Algoritmo de firma: ECDSA (secp256k1)")
    print(f"Algoritmo de hash: SHA3-256")
    print(f"DOI: 10.5281/zenodo.17315719")
    print(f"Frecuencia QCAL: 141.7001 Hz")
    print(f"Estado: ✓ CERTIFICADO Y VERIFICADO")
    print("=" * 70)
    print()
