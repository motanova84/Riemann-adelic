...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Perfectio Spectralis: Enhanced thermal kernel spectral computation")
    parser.add_argument("--N", type=int, default=25, help="Number of basis functions (default: 25)")
    parser.add_argument("--h", type=float, default=0.003, help="Thermal parameter (default: 0.003)")
    parser.add_argument("--validate", action="store_true", default=True, help="Run full validation (default)")
    parser.add_argument("--custom", action="store_true", help="Run with custom N and h parameters")
