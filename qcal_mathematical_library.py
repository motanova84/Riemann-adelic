...
class BibliotecaMatematicaQCAL:
    ...
    def validacion_completa(self) -> Dict[str, Any]:
        ...
        resultados["error_lambda_0"] = abs(resultados["lambda_0_calculado"] - resultados["lambda_0_teorico"])
        ...
        resultados["validacion_exitosa"] = resultados["error_lambda_0"] < 0.01 and all(
            resultados["constantes_coherentes"].values()
        )
