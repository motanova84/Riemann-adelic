...
QCAL ∞³ Framework - Instituto de Conciencia Cuántica (ICQ)
    ...
    parser.add_argument("--precision", type=int, default=50, help="Decimal precision for computations (default: 50)")

    parser.add_argument("--verbose", action="store_true", default=True, help="Print detailed analysis (default: True)")
    ...
    results = clock.run_complete_analysis(verbose=verbose, save_results=args.save_results)
