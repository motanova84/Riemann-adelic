...
adelic_lap_module = load_module("adelic_laplacian", os.path.join(base_dir, "operators", "adelic_laplacian.py"))
ns_adelic_module = load_module("navier_stokes_adelic", os.path.join(base_dir, "operators", "navier_stokes_adelic.py"))
