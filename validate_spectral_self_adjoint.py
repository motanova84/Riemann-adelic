...
def validate_spectral_self_adjoint(lean_file_path: str) -> Dict[str, Any]:
    ...
    if not file_path.exists():
        return {"success": False, "error": f"File not found: {lean_file_path}"}
    ...
    key_axioms = ["H_Ψ_self_adjoint", "spectrum_HΨ_equals_zeros_Ξ"]
    ...
    key_theorems = ["riemann_hypothesis_from_spectral"]
