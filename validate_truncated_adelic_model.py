...
class TruncatedAdelicLaplacian:
    ...
    def plot_results(self, results, C, lambda_, output_file='truncated_model_verification.png'):
        ...
        plt.title('Verificación del resto en modelo truncado controlado\n' + 
